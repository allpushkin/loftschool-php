...
$myName = "Бессмертный Джа";
$myAge = 190;
echo "Меня зовут <b>$myName</b>";
echo "<br>";
echo "Мне $myAge лет";
echo "<br>";
echo "\"!|/\\'\"/";
...
echo "На школьной выставке $total рисунков. 
        Из них $byPencil выполнены карандашами, $byMarker фломастерами, 
        остальные красками. Сколько рисунков выполнены красками?";
echo "<br>";
echo "Количество рисунков выполненных красками = 
        $total - $byMarker - $byPencil = $byPaint";

echo "<h2>Задание #3</h2>";
define("CONST", 777, true);
if (defined("CONST") == true)
    echo "Константа CONST объявлена и равна " . constant("CONST");

echo "<h2>Задание #4</h2>";
echo "Сколько вам лет? ";
echo "<input class=\"input-group mb-2 mr-sm-2 mb-sm-0\" 
        id=\"ageInput\" type=\"text\" onkeyup=\"task4(this.value)\">";
...
foreach ($cars as $item) {
    ...
    echo $item['model'] . " " . $item['speed'] . " " .
         $item['doors'] . " " . $item['year'] . "<br>";
}
